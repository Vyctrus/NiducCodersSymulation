...
userInputData=1000000
packet_size=832 #64->nadmiar 4.25  #tylko potegi 8ki
    ...
    with open("AllDataGenerated.txt", 'w') as mainInput:
        with open("AllDataRecived.txt", 'w') as mainOutput:
            ...
            while (iter < userInputData):
             ...
             #       Channel.passing()
                    BSC_Channel.passing(0.4)
                    #       Gilbert_Channel.passing(0.00, 0.1, 0, 0.5)
             #       Gilbert_Channel.passing   (0.000101648, 0.914789,0.000001,0.31) #idealny
             #       Gilbert_Channel.passing    (0.000196854,0.509547,0.000053513,0.65)#dobry
             #       Gilbert_Channel.passing    (0.000396854,0.2768,0.0003631513,0.9) #niezly
             #       Gilbert_Channel.passing    (0.00496854, 0.3768, 0.000053513,0.9)#sredni
             #       Gilbert_Channel.passing    (0.00496854,0.04,0.0003631513,0.99999) #zly
             #       Gilbert_Channel.passing    (0.00496854, 0.004, 0.0003631513, 0.99999)# fatalny
